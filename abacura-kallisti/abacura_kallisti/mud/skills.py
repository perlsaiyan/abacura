...
SKILL_LIST: List[Skill] = [
    ...
    Skill("sanctuary", renewal="renew", train={"Pal  adin": 70, "Prophet": 16, "Templar": 17}),
    ...
    Skill("shapechange plant", affect_name="shapechange", renewal="expire", train={"Druid": 42}),
    Skill("shapechange mammoth", affect_name="shapechange", renewal="expire", train={"Druid": 49}),
    Skill("shapechange wyvern", affect_name="shapechange", renewal="expire", train={"Druid": 60}),
    Skill("shapechange frost dragon", affect_name="shapechange", renewal="expire", train={"Druid": 65}),
    Skill("shapechange star dragon", affect_name="shapechange", renewal="expire", train={"Druid": 70}),
    Skill("shapechange copper dragon", affect_name="shapechange", renewal="expire", train={"Druid": 75}),
    Skill("shapechange mantis dragon", affect_name="shapechange", renewal="expire", train={"Druid": 100}),
