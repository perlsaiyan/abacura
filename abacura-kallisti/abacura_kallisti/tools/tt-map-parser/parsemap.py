...
fname = "/home/goliath/abakal/map_data.txt"
output_name = "/home/goliath/abakal/worldtest.db"
...
cur.execute("CREATE TABLE IF NOT EXISTS exits(from_vnum,direction,to_vnum,door,closes,locks,key_name,weight,max_level,min_level,deathtrap, commands, PRIMARY KEY (from_vnum, direction))")

cur.execute("CREATE TABLE IF NOT EXISTS rooms(vnum,name,terrain_name,area_name,regen_hp,regen_mp,regen_sp,set_recall,peaceful,deathtrap,silent,wild_magic,bank,narrow,no_magic,no_recall, last_visited, last_harvested, primary key (vnum))")
