...
class LOKMapBlock:
    terrains = {
        ...
        'Beach': Color("", ColorType(3), None, ColorTriplet(238,207,147)),
        'City': Color("", ColorType(3), None, ColorTriplet(40,42,46)),
        'Path': Color("", ColorType(3), None, ColorTriplet(92,49,20)),
        'Forest': Color("", ColorType(3), None, ColorTriplet(28,93,25)),
        'Jungle': Color("", ColorType(3), None, ColorTriplet(28,143,25)),
        'Field': Color("", ColorType(3), None, ColorTriplet(91,163,88)),
        'Hills': Color("", ColorType(3), None, ColorTriplet(121,163,88)),
        'Desert': Color("", ColorType(3), None, ColorTriplet(243,203,147)),
        'Shallow': Color("", ColorType(3), None, ColorTriplet(90,164,228)),
        'Water': Color("", ColorType(3), None, ColorTriplet(52,124,186)),
        'Deep': Color("", ColorType(3), None, ColorTriplet(52, 124,240)),
        'Ocean': Color("", ColorType(3), None, ColorTriplet(52, 104,250)),
        'Underground': Color("", ColorType(3), None, ColorTriplet(55,55,55)),
        'Swamp': Color("", ColorType(3), None, ColorTriplet(55,85,85)),
    }
